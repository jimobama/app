...
class GlobalMaster {
    ...
    static function PartialView($view_name, $controller_name = null, $canRepeat = false) {
        if ($controller_name === null) {
            ...
            if ($bool) {
                ...
                self::displayAtLocation($controller, $view_name, $canRepeat);
            }
        } else {
            $bool = self::$include_global->offsetExists($view_name);
            if ($bool) {
    ...
    private static function displayAtLocation($controller, $action, $canRepeat = false) {
